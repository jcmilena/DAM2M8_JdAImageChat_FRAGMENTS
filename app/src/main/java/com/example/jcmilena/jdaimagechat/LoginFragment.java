...
public class LoginFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mSignupButton = view.findViewById(R.id.signButton);
        mEmailEditText = view.findViewById(R.id.emailEditText);
        mPassEditText = view.findViewById(R.id.passwordEditText);
        mLoginButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mListener.login(mEmailEditText.getText().toString(),
        ...
        mSignupButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mListener.signup(mEmailEditText.getText().toString(),
                        mPassEditText.getText().toString());
            }
        });
